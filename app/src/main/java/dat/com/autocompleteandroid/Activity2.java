...
public class Activity2 extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // etOrigin = (EditText) findViewById(R.id.etOrigin);
        ...
        etDestination.setText(getIntent().getExtras().getString("id"));
